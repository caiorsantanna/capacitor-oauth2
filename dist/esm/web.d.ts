...
export declare class OAuth2ClientPluginWeb extends WebPlugin implements OAuth2ClientPlugin {
    ...
    getAccessTokenFromCode(authorizationRedirectUrlParamObj: any, resolve: any, reject: any): void;
    openWindow(resolve: any, reject: any): void;
    authenticate(options: OAuth2AuthenticateOptions): Promise<unknown>;
