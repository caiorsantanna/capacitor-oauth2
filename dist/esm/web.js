...
export class OAuth2ClientPluginWeb extends WebPlugin {
    ...
    getAccessTokenFromCode(authorizationRedirectUrlParamObj, resolve, reject) {
    ...
    openWindow(resolve, reject) {
        ...
        this.windowHandle = window.open(authorizationUrl, this.webOptions.windowTarget, this.webOptions.windowOptions);
        ...
        this.intervalId = window.setInterval(() => {
            ...
            else if (((_a = this.windowHandle) === null || _a === void 0
                ? void 0
                : _a.closed) &&
                ...
                if (href != null &&
                    ...
                    if (authorizationRedirectUrlParamObj) {
                        ...
                        if (authorizationRedirectUrlParamObj.state ===
                            ...
                            this.getAccessTokenFromCode(authorizationRedirectUrlParamObj, resolve, reject);
                        }
                        else {
                            if (this.webOptions.logsEnabled) {
    ...
    async authenticate(options) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!this.webOptions.appId || this.webOptions.appId.length == 0) {
                ...
                if (options.code) {
                    this.getAccessTokenFromCode({ code: options.code }, resolve, reject);
                }
                else
                    this.openWindow(resolve, reject);
            }
        });
    }
    ...
    closeWindow() {
        ...
        // }
        (_c = this.windowHandle) === null || _c === void 0 ? void 0 : _c.close();
